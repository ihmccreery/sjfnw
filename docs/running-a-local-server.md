To start up the local server, (from inside the root of the repo) do
...
The superuser you created in the `syncdb` step of [[setup|installation-and-setup#setting-up-the-database]] gives you access to the admin site. For testing locally you'll want to be able to log into the fundraising and grant application areas too.
